...
首先你需要選一個 Public 的 Github repo 來放置留言，如果你在本系列文 [Day3 將 Next.js 專案部署上 Vercel 平台](https://ithelp.ithome.com.tw/articles/10293504) 裡面是從 Github repo 來部署上 Vercel 平台的話，你應該已經有 Github repo 了，可以使用它來放置留言。
